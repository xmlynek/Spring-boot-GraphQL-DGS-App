...
@DgsDataLoader(name = DataLoaderConstants.SIMPLE_MODEL_REST_DATA_LOADER_NAME)
public class SimpleModelRestDataLoader implements MappedBatchLoader<String, ModelSimple> {
    ...
    public SimpleModelRestDataLoader(ProductQueryService productQueryService,
    ...
    public CompletionStage<Map<String, ModelSimple>> load(Set<String> keys) {
        return CompletableFuture.supplyAsync(() -> productQueryService.loadSimpleModelsRest(keys),
